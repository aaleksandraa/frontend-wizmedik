        ...
        return (
          <>
            <Helmet>
              ...
              <title>Stranica se učitava | WizMedik</title>
            </Helmet>
              ...
              <Card className="max-w-xl w-full">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <CardTitle className="text-2xl">Stranica se osvježava</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="space-y-4">
                  <p className="text-gray-600">
                    Aplikacija je ažurirana. Molimo osvježite stranicu kako biste učitali najnoviju verziju.
                  </p>
