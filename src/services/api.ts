...
export const laboratoriesAPI = {
  ...
  getStatistics: () => api.get('/laboratorije/statistics'),
  searchAnalize: (params?: any) => api.get('/laboratorije/search-analize', { params }),
  getPopularneAnalize: () => api.get('/laboratorije/popularne-analize'),
  getAnalizenaAkciji: () => api.get('/laboratorije/analize-na-akciji'),
  
  // Dashboard routes (requires auth + laboratory role)
  getProfile: () => api.get('/laboratorija/profile'),
  updateProfile: (data: any) => api.put('/laboratorija/profile', data),
  getDashboardStatistics: () => api.get('/laboratorija/statistics'),
  getDashboardAnalize: (params?: any) => api.get('/laboratorija/analize', { params }),
  createAnaliza: (data: any) => api.post('/laboratorija/analize', data),
  updateAnaliza: (id: number, data: any) => api.put(`/laboratorija/analize/${id}`, data),
  deleteAnaliza: (id: number) => api.delete(`/laboratorija/analize/${id}`),
  getDashboardPaketi: (params?: any) => api.get('/laboratorija/paketi', { params }),
  createPaket: (data: any) => api.post('/laboratorija/paketi', data),
  updatePaket: (id: number, data: any) => api.put(`/laboratorija/paketi/${id}`, data),
  deletePaket: (id: number) => api.delete(`/laboratorija/paketi/${id}`),
  getGalerija: () => api.get('/laboratorija/profile'),
  uploadGalerija: (data: any) => api.post('/laboratorija/galerija/upload', data),
  deleteGalerija: (id: number) => api.delete(`/laboratorija/galerija/${id}`),
  getRadnoVrijeme: () => api.get('/laboratorija/profile'),
...
export const spasAPI = {
  ...
  getMojaBanja: () => api.get('/spa/profile'),
  updateMojaBanja: (data: any) => api.put('/spa/profile', data),
  getStatistika: () => api.get('/spa/statistics'),
  toggleActive: () => api.post('/spa/toggle-active'),
  getUpiti: (params?: any) => api.get('/spa/upiti', { params }),
  oznacUpitProcitan: (id: number) => api.put(`/spa/upiti/${id}/procitan`),
  oznacUpitOdgovoren: (id: number) => api.put(`/spa/upiti/${id}/odgovoren`),
  zatvoriUpit: (id: number) => api.put(`/spa/upiti/${id}/zatvori`),
  getDashboardRecenzije: (params?: any) => api.get('/spa/recenzije', { params }),
  
  // Admin routes (requires auth + admin role)
  adminGetAll: (params?: any) => api.get('/admin/spas', { params }),
  adminCreate: (data: any) => api.post('/admin/spas', data),
  adminUpdate: (id: number, data: any) => api.put(`/admin/spas/${id}`, data),
  adminDelete: (id: number) => api.delete(`/admin/spas/${id}`),
  adminVerify: (id: number) => api.post(`/admin/spas/${id}/verify`),
  adminToggleActive: (id: number) => api.post(`/admin/spas/${id}/toggle-active`),
  adminGetDashboardStats: () => api.get('/admin/spas/statistika/dashboard'),
  adminGetAuditLog: (id: number, params?: any) => api.get(`/admin/spas/audit-log/${id}`, { params }),
  adminGetRecenzije: (params?: any) => api.get('/admin/spas/recenzije', { params }),
  adminOdobriRecenziju: (id: number) => api.post(`/admin/spas/recenzije/${id}/odobri`),
  adminOdbijRecenziju: (id: number) => api.delete(`/admin/spas/recenzije/${id}`),
  adminGetUpiti: (params?: any) => api.get('/admin/spas/upiti', { params }),
};
