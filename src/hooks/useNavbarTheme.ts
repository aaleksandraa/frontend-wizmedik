...
const templateThemes: Record<string, NavbarTheme> = {
  'custom2-cyan': {
    variant: 'colored',
    bgColor: 'bg-gradient-to-br from-cyan-50 via-cyan-50 to-teal-50',
  ...
  'zocdoc': {
    ...
    activeTextColor: 'text-[#0891b2]',
    borderColor: 'border-[#d0e8e0]',
    logoGradient: 'from-[#0891b2] to-[#00a085]',
    buttonBg: 'bg-[#0891b2] text-white',
  ...
  'ocean': {
    ...
    activeTextColor: 'text-cyan-700',
    borderColor: 'border-cyan-200',
    logoGradient: 'from-cyan-600 to-cyan-500',
    buttonBg: 'bg-cyan-600 text-white',
    buttonHoverBg: 'hover:bg-cyan-700',
  },
  'lime': {
