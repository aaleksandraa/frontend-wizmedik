    ...
    const faqSchema = {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Mnogi domovi u BiH imaju specijalizirane odjele za osobe sa demencijom i Alzheimerovom bolešcu. Ovi odjeli imaju obuceno osoblje i prilagodene prostore za sigurnu njegu osoba sa kognitivnim poremecajima."
          }
        }
      ]
    };
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="faq-4">
                ...
                <AccordionContent className="text-muted-foreground">
                  <p>Da, mnogi domovi u Bosni i Hercegovini imaju specijalizirane odjele za osobe sa demencijom i Alzheimerovom bolešcu. Ovi odjeli karakteriše:</p>
                  <ul className="list-disc list-inside mt-2 space-y-1">
              ...
              <AccordionItem value="faq-5">
                ...
                <AccordionContent className="text-muted-foreground">
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    ...
                    <li>Obratite pažnju na cistocu, atmosferu i odnos osoblja prema šticenicima</li>
        ...
        <section className="bg-gray-50 py-12 border-t" aria-labelledby="info-heading">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <p>
                Bilo da tražite dom sa osnovnom njegom za samostalne starije osobe, pojacanu njegu za one kojima je potrebna svakodnevna pomoc, ili specijaliziranu njegu za osobe sa demencijom i Alzheimerovom bolešcu - na pravom ste mjestu.
              </p>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>Autenticne recenzije od porodica šticenika</li>
